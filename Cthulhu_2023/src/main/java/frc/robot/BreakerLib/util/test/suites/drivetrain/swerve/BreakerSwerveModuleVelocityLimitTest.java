...
public class BreakerSwerveModuleVelocityLimitTest extends BreakerTestBase{
    ...
    public BreakerSwerveModuleVelocityLimitTest(BreakerSwerveDrive drivetrain, BreakerGenericSwerveModule[] swerveModules, double maxVelocityToTest, double timeoutSeconds, BreakerTestSuiteDataLogType logType) {
