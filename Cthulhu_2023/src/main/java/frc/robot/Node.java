...
public final class Node {
    ...
    public static final Node[] NODES = new Node[] {
        new Node(NodeLevel.HIGH, COLUMNS[0], NodeType.CONE, ArmState.PLACE_HIGH),
        new Node(NodeLevel.HIGH, COLUMNS[1], NodeType.CUBE, ArmState.PLACE_HIGH),
        new Node(NodeLevel.HIGH, COLUMNS[2], NodeType.CONE, ArmState.PLACE_HIGH),
        new Node(NodeLevel.HIGH, COLUMNS[3], NodeType.CONE, ArmState.PLACE_HIGH),
        new Node(NodeLevel.HIGH, COLUMNS[4], NodeType.CUBE, ArmState.PLACE_HIGH),
        new Node(NodeLevel.HIGH, COLUMNS[5], NodeType.CONE, ArmState.PLACE_HIGH),
        new Node(NodeLevel.HIGH, COLUMNS[6], NodeType.CONE, ArmState.PLACE_HIGH),
        new Node(NodeLevel.HIGH, COLUMNS[7], NodeType.CUBE, ArmState.PLACE_HIGH),
        new Node(NodeLevel.HIGH, COLUMNS[8], NodeType.CONE, ArmState.PLACE_HIGH),
        new Node(NodeLevel.MIDDLE, COLUMNS[0], NodeType.CONE, ArmState.PLACE_MEDIUM),
        new Node(NodeLevel.MIDDLE, COLUMNS[1], NodeType.CUBE, ArmState.PLACE_MEDIUM),
        new Node(NodeLevel.MIDDLE, COLUMNS[2], NodeType.CONE, ArmState.PLACE_MEDIUM),
        new Node(NodeLevel.MIDDLE, COLUMNS[3], NodeType.CONE, ArmState.PLACE_MEDIUM),
        new Node(NodeLevel.MIDDLE, COLUMNS[4], NodeType.CUBE, ArmState.PLACE_MEDIUM),
        new Node(NodeLevel.MIDDLE, COLUMNS[5], NodeType.CONE, ArmState.PLACE_MEDIUM),
        new Node(NodeLevel.MIDDLE, COLUMNS[6], NodeType.CONE, ArmState.PLACE_MEDIUM),
        new Node(NodeLevel.MIDDLE, COLUMNS[7], NodeType.CUBE, ArmState.PLACE_MEDIUM),
        new Node(NodeLevel.MIDDLE, COLUMNS[8], NodeType.CONE, ArmState.PLACE_MEDIUM),
