...
public class Drive extends BreakerSwerveDrive {
    ...
    private static BreakerSwerveDriveConfig config = new BreakerSwerveDriveConfig(
        ...
        DRIVE_MOTOR_GEAR_RATIO_TO_ONE, WHEEL_DIAMETER, MODULE_WHEEL_SPEED_DEADBAND, Constants.DRIVE.MAX_ATTAINABLE_MODULE_WHEEL_SPEED,
        new BreakerArbitraryFeedforwardProvider(STATIC_FRICTION_COEFFICIENT, VELOCITY_COEFFICIENT),
        FL_TRANSLATION, FR_TRANSLATION, BL_TRANSLATION, BR_TRANSLATION)
        .setSlowModeMultipliers(LINEAR_MULTIPLIER, TURN_MULTIPLIER);

    private static BreakerMK4iFalconSwerveModule 
