...
public final class Constants {
    ...
    public static final class DriveConstants {
        ...
        public static final double FL_ENCODER_OFFSET = 54.492;
        public static final double FR_ENCODER_OFFSET = 159.434;
        public static final double BL_ENCODER_OFFSET = -67.061;
        public static final double BR_ENCODER_OFFSET = -111.357;
